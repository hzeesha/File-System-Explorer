...
public class TestFileStructure {
	...
	private static String[] files = { "folder1:0:", "folder2:3:file1.java:file2.txt:file3.java:",
			"folder2/file1.java:0:", "folder2/file2.txt:0:", "folder2/file3.java:0:",
			"folder3:3:folderA:folderB:folderC:", "folder3/folderA:2:folderB:folderD:", "folder3/folderB:1:file1.gif:",
	...
	/*
	 * Test that FileStructure objects created have the correct structure, so all
	 * nodes are created and they have the correct set of children. Test also
	 * methods filesOfType and findFile from class FileStructure.
	 */
